    ...
    switch ($form_id) {
        ...
        case 'webform_client_form_60233': /* enlish cal mediconnect */
          ...
          ' . t('Required Fields') . '</label></div>',
            ...
            $form['submitted']['language_select']['#options'][base_path() . 'healthcare-plans/calmediconnect/appeal-grievances/file-an-appeal/formulario-de-quejas-del-miembro'] = t('español');
            $form['submitted']['language_select']['#options'][base_path() . 'healthcare-plans/calmediconnect/appeal-grievances/file-an-appeal/mau-khieu-nai-cua-hoi-vien'] = t('Tiếng Việt');
            $form['submitted']['language_select']['#options'][base_path() . 'healthcare-plans/calmediconnect/appeal-grievances/file-an-appeal/tou-su-biao-ge'] = t('中文');
            switch ($form_id) {

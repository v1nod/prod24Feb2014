 ...
 */
 ...
 function santaclara_breadcrumb(&$variables){
...
function santaclara_form_alter(&$form, &$form_state, $form_id) {
  switch($form_id) {
    ...
    case 'webform_client_form_76':
      ...
      $form['submitted']['language_select']['#options'][base_path() . 'grievances/form'] = t('English');
      $form['submitted']['language_select']['#options'][base_path() . 'es/grievances/form'] = t('Spanish');
      $form['submitted']['language_select']['#options'][base_path() . 'vi/grievances/form'] = t('Vietnamese');
      switch($form_id){
        case 'webform_client_form_67':
          $form['submitted']['language_select']['#default_value'] = base_path() . 'grievances/form';
          break;

        case 'webform_client_form_75':
          $form['submitted']['language_select']['#default_value'] = base_path() . 'es/grievances/form';
          break;

        case 'webform_client_form_76':
          $form['submitted']['language_select']['#default_value'] = base_path() . 'vi/grievances/form';
          break;
      }
      break;
  }

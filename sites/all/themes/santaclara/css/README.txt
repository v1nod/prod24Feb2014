...
To use these stylesheets, rename the files and santaclara with the name of your theme.
...
santaclara-alpha-default-narrow.css  
...
santaclara-alpha-default-normal.css
...
santaclara-alpha-default-wide.css

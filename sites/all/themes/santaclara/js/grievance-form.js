(function ($) {
    ...
    Drupal.behaviors.grievanceFormText = {
        ...
        attach: function(context, settings) {
            ...
            //                read_more = '&nbsp;<a id="gf-read-more" href="#read-more">' + Drupal.t('đ�?c thêm') + '</a>';
            ...
            if (($('body').hasClass('page-node-67')) || ($('body').hasClass('page-node-60233')) ) {
                ...
                $('#webform-component-mo-ta-chi-tiet-ve-van-de').append('<div class="error_message" style="display: none;" id="error_message_birthdate">Xin đi�?n chi tiết v�? vấn đ�? Xin điền chi tiết về vấn đề</div>');
            }
            ...
            /* Added by Astha starts */
                ...
                $('#webform-component-hui-yuan-ming-cheng-').append('<div class="error_message" style="display: none;">请输入有效的�??称</div>');
                ...
                $('#webform-component-xiang-xi-miao-shu-wen-ti--describe-the-problem-in-detail').append('<div class="error_message" style="display: none;">请输入问题�??述</div>');
                
                $('#webform-component-you-zheng-bian-ma--zipcode').append('<div class="error_message" style="display: none;">请输入有效的邮政编�?</div>');
            ...
            /*  Add Reset button by Astha starts  */

            //$('.page-node-60227 #edit-submit, #edit-next').parent().append('<input type="reset" id="edit-reset" value="' + Drupal.t('Clear') + '" class="form-submit"/>');  /* Edited by Astha */
            
            
            $('#node-webform-60233 #edit-next, #node-webform-67 #edit-next').parent().append('<input type="reset" id="edit-reset" value="' + Drupal.t('Clear') + '" class="form-submit"/>');     /* For Cal MediConnect English reset button */
            
            $('#node-webform-60234 #edit-next, #node-webform-60231 #edit-next').parent().append('<input type="reset" id="edit-reset" value="' + Drupal.t('Borrar') + '" class="form-submit"/>');    /* For Cal MediConnect Spanish reset button */
            
            $('#node-webform-60236 #edit-next, #node-webform-60224 #edit-next').parent().append('<input type="reset" id="edit-reset" value="' + Drupal.t('清除') + '" class="form-submit"/>');       /* For Cal MediConnect Chinese reset button */
            
            $('#node-webform-60235 #edit-next, #node-webform-60232 #edit-next').parent().append('<input type="reset" id="edit-reset" value="' + Drupal.t('Xoá B�?') + '" class="form-submit"/>');    /* For Cal MediConnect Vietnamese reset button */
            ...
            $('#edit-reset').click(function(event){
                ...
                /* Added by Astha to reset value on 12Jan13 starts */
                
                $('#webform-client-form-60233').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                
                $('#webform-client-form-60231').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                
                $('#webform-client-form-60234').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                
                $('#webform-client-form-60236').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                
                $('#webform-client-form-60224').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                
                $('#webform-client-form-60235').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                
                $('#webform-client-form-60232').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                
                $('#webform-client-form-67').find('.form-text, .form-textarea, select').each(function() {
                    $(this).val('');
                });
                /* Added by Astha to reset value ends */
                        
                validate_webform($('form.webform-client-form'));     /* To disable submit button when reset is clicked on Cal MediConnect English form */
                
                validate_webform_chinese_cal($('form.webform-client-form'));   /* To disable submit button when reset is clicked on Cal MediConnect Chinese form */
                
                validate_webform_chinese($('form.webform-client-form'));   /* To disable submit button when reset is clicked on For Members Chinese form */
                
                validate_webform_spanish_cal($('form.webform-client-form'));   /* To disable submit button when reset is clicked on Cal MediConnect Spanish form */
                
                validate_webform_spanish($('form.webform-client-form'));   /* To disable submit button when reset is clicked on For Members Spanish form */
                
                validate_webform_vietnamese_cal($('form.webform-client-form'));   /* To disable submit button when reset is clicked on Cal MediConnect Vietnamese form */
                
                validate_webform_vietnamese($('form.webform-client-form'));   /* To disable submit button when reset is clicked on For Members Vietnamese form */

                event.preventDefault();

            });
            
            /*  Add Reset button by Astha ends  */
            ...
            //                jQuery('#webform-component-numero-de-identificacion-del-miembro').click(function(){
            //                    var cl = $('#edit-next').attr('class').split(' ')[1];
            //                    if(cl != 'disabled') {
            //                        alert('astha');
            //                        var TT = 'Asas';
            //                        var dob_sp_month = $('.webform-preview #webform_spanish_dob #edit_submitted_dobs_dob_months_chzn .chzn-single span').html();
            //                 
            //                        var dob_sp_day = $('.webform-preview #webform_spanish_dob #edit_submitted_dobs_sdob_day_31_chzn .chzn-single span').html();
            //                        alert(dob_sp_day);
            //                        var dob_sp_year = jQuery('.webform-preview #webform_spanish_dob #edit_submitted_dobs_dob_years_chzn .chzn-single span').html();
            //                        alert(dob_sp_year);
            //                        $( "#webform-component-numero-de-identificacion-del-miembro" ).after( "<p>Test</p>" );
            //                    //jQuery("#webform-component-numero-de-identificacion-del-miembro").after("<div id='webform-component-birthdate' class='form-item webform-component webform-component-display'><label for='edit-submitted-birthdate'>Date of birth </label><div class='content'>" + 2103 +"-"+ dob_sp_month + "-" + dob_sp_day + " </div></div>");
            //                   
            //                    
            //                    } 
            //                });
            ...
            jQuery(window).load(function(){
                ...
                /* For calmediconnect spanish form starts dob */
                var dob_sp_month = jQuery('#edit_submitted_dobs_dob_months_chzn .chzn-single span').html();
                
                var dob_sp_day = jQuery('#edit_submitted_dobs_sdob_day_31_chzn .chzn-single span').html();
                      
                var dob_sp_year = jQuery('#edit_submitted_dobs_dob_years_chzn .chzn-single span').html();
                  
                if(dob_sp_month != 'Mes') {
                    jQuery(".webform-preview #webform-component-numero-de-identificacion-del-miembro").after("<div id='webform-component-birthdate' class='form-item webform-component webform-component-display'><label for='edit-submitted-birthdate'>Fecha de nacimiento </label><div class='content'>" + dob_sp_year +"-"+ dob_sp_month + "-" + dob_sp_day + " </div></div>"); 
                }
                /* For calmediconnect vietnamese form starts dob */
                var dob_vit_month = jQuery('#edit_submitted_dobv_dob_monthv_chzn .chzn-single span').html();
                
                var dob_vit_day = jQuery('#edit_submitted_dobv_vdob_day_31_chzn .chzn-single span').html();
                      
                var dob_vit_year = jQuery('#edit_submitted_dobv_dob_yearv_chzn .chzn-single span').html();
                
                if(dob_vit_month != 'Tháng') {    
                    jQuery(".webform-preview #webform-component-so-id-hoi-vien").after("<div id='webform-component-birthdate' class='form-item webform-component webform-component-display'><label for='edit-submitted-birthdate'>Ngày Sinh </label><div class='content'>" + dob_vit_year +"-"+ dob_vit_month + "-" + dob_vit_day + " </div></div>"); 
                }
                /* For calmediconnect chinese form starts dob */
                var dob_ch_month = jQuery('#edit_submitted_dob_dob_month_chzn .chzn-single span').html();
                
                var dob_ch_day = jQuery('#edit_submitted_dob_dob_day_31_chzn .chzn-single span').html();
                      
                var dob_ch_year = jQuery('#edit_submitted_dob_dob_year_chzn .chzn-single span').html();
                 
                if(dob_ch_month != '年') { 
                    jQuery(".webform-preview #webform-component-hui-yuan--id").after("<div id='webform-component-birthdate' class='form-item webform-component webform-component-display'><label for='edit-submitted-birthdate'>出生日期 </label><div class='content'>" + dob_ch_year +"-"+ dob_ch_month + "-" + dob_ch_day + " </div></div>"); 
                }
               
                /* For calmediconnect spanish form starts dop */
                var dop_sp_month = jQuery('#edit_submitted_dops_dop_months_chzn .chzn-single span').html();
                
                var dop_sp_day = jQuery('#edit_submitted_dops_sdop_day_31_chzn .chzn-single span').html();
                      
                var dop_sp_year = jQuery('#edit_submitted_dops_dop_years_chzn .chzn-single span').html();
                
                if(dop_sp_month != 'Mes') { 
                    jQuery(".webform-preview #webform-component-numero-de-identificacion-del-miembro").after("<div id='webform-component-birthdate' class='form-item webform-component webform-component-display'><label for='edit-submitted-birthdate'>Fecha del problema </label><div class='content'>" + dop_sp_year +"-"+ dop_sp_month + "-" + dop_sp_day + " </div></div>"); 
                }
                /* For calmediconnect vietnamese form starts dop */
                var dop_vit_month = jQuery('#edit_submitted_dopv_dop_monthv_chzn .chzn-single span').html();
                
                var dop_vit_day = jQuery('#edit_submitted_dopv_vdop_day_31_chzn .chzn-single span').html();
                      
                var dop_vit_year = jQuery('#edit_submitted_dopv_dop_yearv_chzn .chzn-single span').html();
                
                if(dop_vit_month != 'Tháng') {
                    jQuery(".webform-preview #webform-component-so-id-hoi-vien").after("<div id='webform-component-birthdate' class='form-item webform-component webform-component-display'><label for='edit-submitted-birthdate'>Ngày xảy ra vấn đ�? </label><div class='content'>" + dop_vit_year +"-"+ dop_vit_month + "-" + dop_vit_day + " </div></div>"); 
                }
               
                /* For calmediconnect chinese form starts dop */
                var dop_ch_month = jQuery('#edit_submitted_dop_dop_month_chzn .chzn-single span').html();
                
                var dop_ch_day = jQuery('#edit_submitted_dop_dop_day_31_chzn .chzn-single span').html();
                      
                var dop_ch_year = jQuery('#edit_submitted_dop_dop_year_chzn .chzn-single span').html();
                 
                if(dop_ch_month != '年') { 
                    jQuery(".webform-preview #webform-component-hui-yuan--id").after("<div id='webform-component-birthdate' class='form-item webform-component webform-component-display'><label for='edit-submitted-birthdate'>出现问题的日期 </label><div class='content'>" + dop_ch_year +"-"+ dop_ch_month + "-" + dop_ch_day + " </div></div>"); 
                }
            }); 
        }
    };

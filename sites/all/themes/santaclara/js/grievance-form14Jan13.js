...
*/
            ...
            */
            ...
            $('#node-webform-60235 #edit-next, #node-webform-60232 #edit-next').parent().append('<input type="reset" id="edit-reset" value="' + Drupal.t('Xoá Bỏ') + '" class="form-submit"/>');    /* For Cal MediConnect Vietnamese reset button */
